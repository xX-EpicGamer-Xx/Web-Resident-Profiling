    ...
    if (!$error_found) {
        ...
        if (function_exists('getDatabaseConnection')) {
            ...
            if ($dbConnection) {
                ...
                if ($statement) {
                    $statement->bind_param('sssssss', $first_name, $last_name, $email, $phone, $hashed_password, $created_at);
...
<head>
    ...
    <style>
        ...
        #last-name-text, #first-name-text, #middle-name-text, #phone-text,  #username-text, #password-text, #email-address-text, #confirm-password-text  {
            position: absolute;
            background: transparent; 
            color: #ffffff;
            font-size: 20px;
        ...
        #last-name, #first-name, #middle-name, #phone,  #username, #password, #email-address, #confirm-password  {
            position: absolute;
            width: 40%;
            height: 10%;
            background: transparent; 
...
<body>
    ...
    <div class="form-group">
        <label for="first_name" id="first-name-text" style="top: 19%; left: 5%;">First Name</label>
        <input type="text" id="first-name" name="first_name" class="form-control custom-input" value="<?= htmlspecialchars($first_name) ?>" placeholder="First Name" required style="top: 25%; left: 5%;">
        <span class="text-danger"><?= $first_name_error ?></span>
    </div>

    <div class="form-group">
        <label for="last_name" id="last-name-text" style="top: 19%; left: 52%;">Last Name</label>
        <input type="text" id="last-name" name="last_name" class="form-control custom-input" value="<?= htmlspecialchars($last_name) ?>" placeholder="Last Name" required style="top: 25%; left: 52%;">
        <span class="text-danger"><?= $last_name_error ?></span>
    </div>

    <div class="form-group">
        <label for="email" id="email-address-text" style="top: 44%; left: 5%;">Email</label>
        <input type="email" id="email-address" name="email" class="form-control custom-input" value="<?= htmlspecialchars($email) ?>" placeholder="Email" required style="top: 50%; left: 5%;">
        <span class="text-danger"><?= $email_error ?></span>
    </div>

    <div class="form-group">
        <label for="phone" id="phone-text" style="top: 44%; left: 52%;">Phone</label>
        <input type="text" id="phone" name="phone" class="form-control custom-input" value="<?= htmlspecialchars($phone) ?>" placeholder="Phone" required style="top: 50%; left: 52%;">
        <span class="text-danger"><?= $phone_error ?></span>
    </div>

    <div class="form-group">
        <label for="password" id="password-text" style="top: 69%; left: 5%;">Password</label>
        <input type="password" id="password" name="password" class="form-control custom-input" placeholder="Password" required style="top: 75%; left: 5%;">
        <span class="text-danger"><?= $password_error ?></span>
    </div>

    <div class="form-group">
        <label for="confirm_password" id="confirm-password-text" style="top: 69%; left: 52%;">Confirm Password</label>
        <input type="password" id="confirm-password" name="confirm_password" class="form-control custom-input" placeholder="Confirm Password" required style="top: 75%; left: 52%;">
